...
//           {/* Brand */}
//           <div>
//             <h3 className="text-xl font-bold mb-4">EverMoment <span className="text-[#d4af37]">Studio</span></h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Turning every moment into a beautiful memory 💖
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/create" className="text-gray-300 hover:text-gold transition-colors">
                  Create
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/refund" className="text-gray-300 hover:text-gold transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          ...
          <p className="text-sm text-gray-400 mb-3">
            EverMoment Studio | Privacy Policy | Terms of Service
          </p>

          {/* Designer Credit */}
          <p className="text-sm text-gray-200 font-medium">
            Designed &amp; Developed with ❤️ by{" "}
            <span className="text-white">Ramu Palla</span>
          </p>
          ...
          <p className="text-xs text-gray-500 mt-4">
            © {new Date().getFullYear()} All rights reserved. Crafted with care & emotion.
          </p>
        </div>
